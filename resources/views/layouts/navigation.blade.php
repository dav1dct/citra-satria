<nav x-data="{ open: false }" class="bg-[#111827] dark:bg-[#111827] border-b border-[#111827] dark:border-[#111827]">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-black dark:text-black bg-gray-800 dark:bg-gray-800 hover:text-gray-300 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden text-black">
        ...
        <div class="pt-4 pb-1 border-t border-gray-600 dark:border-gray-600 text-black">
            <div class="px-4">
